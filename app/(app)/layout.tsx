...
export default async function AppLayout({
  ...
  return (
    <AuthProvider><div className="flex">
      ...
      <main className="min-w-0 flex-1 min-h-screen pt-16 md:pt-0"><div className="flex justify-end border-b border-line bg-panel px-5 py-3"><OrganizationSwitcher organizations={ctx.organizations} activeId={ctx.org.id} /></div>{children}</main>
    </div></AuthProvider>
  );
}
