  ...
  return <main className="landing-page min-h-screen overflow-hidden bg-[#f7f8f8] text-ink">
    <header className="landing-shell relative z-20 flex h-[96px] items-center justify-between gap-4">
      <Link href="/" className="group flex items-center" aria-label="ProConnect Express WMS Platform home">
        <Image src="/proconnect-express-wms-logo-20260916.png" width={206} height={114} priority unoptimized alt="ProConnect Express WMS Platform" className="landing-logo-image" />
      </Link>
    ...
    <footer className="border-t border-ink/10 bg-white"><div className="landing-shell grid gap-8 py-9 text-sm text-graphite lg:grid-cols-[1fr_auto_1fr] lg:items-center"><div><Image src="/proconnect-express-wms-logo-20260916.png" width={128} height={71} unoptimized alt="ProConnect Express WMS Platform" className="landing-footer-logo" /></div><p className="text-center text-xs leading-6">© 2026 Proconnect Express Services (JM0993273-A). All rights reserved.</p><div className="flex flex-wrap justify-start gap-x-5 gap-y-2 lg:justify-end"><a href="https://www.proconnect-express.com/home" target="_blank" rel="noreferrer" className="font-medium text-rack hover:underline">ProConnect Express Services <ExternalLink className="ml-1 inline-block" size={13} /></a><span className="text-xs">Designed &amp; hosted by <span className="font-semibold text-ink">ProNexa Technology</span></span><Link href="/login" className="font-medium text-rack hover:underline">Client login</Link></div></div></footer>
  </main>;
}
