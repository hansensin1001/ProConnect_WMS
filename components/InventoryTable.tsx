...
type Row = { id: string; sku: string; barcode: string; name: string; description?: string | null; price?: number; unit_of_measure: string; onHand: number; reserved: number; locations: number; stockByLocation?: StockByLocation[] };
